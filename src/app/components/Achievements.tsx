...
export function Achievements() {
  const achievements = [
    ...
    },
    {
      ...
      description: 'Reduced app load time by 65% at previous company',
      date: '2021',
    },
    {
      icon: Award,
    ...
    },
    {
      ...
      description: '20+ technical articles with 100K+ views',
      date: 'Ongoing',
    },
  ];
  ...
  return (
    <section id="achievements" className="py-20 bg-gray-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-4xl text-center mb-4 text-white">Achievements</h2>
            ...
            >
              <Card className="bg-gray-900/50 backdrop-blur-lg border-gray-800 hover:shadow-lg hover:shadow-purple-500/10 transition-all">
                <CardContent className="pt-6">
                  ...
                  >
                    <achievement.icon size={28} className="text-blue-400" />
                  </motion.div>
